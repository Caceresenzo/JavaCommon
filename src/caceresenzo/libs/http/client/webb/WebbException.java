...
/**
 * Runtime exception wrapping the real exception thrown by HttpUrlConnection.
 */
public class WebbException extends RuntimeException {
	...
	/**
	 * Get the Response object (only available if exception has been raised by {@link caceresenzo.libs.http.client.webb.Request#ensureSuccess()}.
	 *
