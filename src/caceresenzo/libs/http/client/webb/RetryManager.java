...
public class RetryManager {
	 ...
	 * This is not covering all situations and in case of doubt the exception is considered not recoverable. @YOU: if you find a case where an exception is recoverable, create an issue!
	 * 
	 * @param webbException
