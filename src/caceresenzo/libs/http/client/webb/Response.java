...
public class Response<T> {
	 ...
	 * <li>The expected type (see <code>asXyz()</code>). We try to coerce the error body to this type. In case of REST services, where often a JSONObject is the normal response body, the error body will be converted to JSONObject if possible. <code>JSONArray</code> is not expected to be the error body.</li>
	 * </ul>
	 * If converting the error body is not successful, <code>String</code> and <code>byte[]</code> is used as a fallback. You have to check the type with <code>instanceof</code> or try/catch the cast.
	 * 
	...
	/**
	 * See <a href="http://docs.oracle.com/javase/7/docs/api/java/net/HttpURLConnection.html#responseCode"> HttpURLConnection.responseCode</a>
	 * 
	...
	public String getStatusLine() {
		return getConnection().getHeaderField(null);
	}
	...
	public boolean isSuccess() {
		return (getStatusCode() / 100) == 2; // 200, 201, 204, ...
	}
	 ...
	 * See <a href="http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getContentType()"> URLConnection.getContentType()</a>
	 *
	 ...
	 * See <a href="http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getDate()"> URLConnection.getDate()</a>
	 *
	 ...
	 * See <a href="http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getExpiration()"> URLConnection.getExpiration()</a>
	 *
	 * @return the expiration date of the resource, or 0 if not known.
	 */
	public long getExpiration() {
		return getConnection().getExpiration();
	}
	
	/**
	 * Returns the value of the last-modified header field. <br>
	 * See <a href="http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getLastModified()"> URLConnection.getLastModified()</a>
	 *
	 ...
	 * See <a href="http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getHeaderField(java.lang.String)"> URLConnection.getHeaderField()</a>
	 *
	 * @param name
	 ...
	 * See <a href="http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getHeaderFieldDate(java.lang.String,+long)"> URLConnection.getHeaderFieldDate()</a>
	 *
	 * @param field
	 *            name of the header field
	 * @param defaultValue
	...
	public long getHeaderFieldDate(String field, long defaultValue) {
		return getConnection().getHeaderFieldDate(field, defaultValue);
	}
	
	/**
	 * Returns the value of the named field parsed as a number. <br>
	 * See <a href="http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getHeaderFieldInt(java.lang.String,+int)"> URLConnection.getHeaderFieldInt()</a>
	 *
	 * @param field
	 *            name of the header field
	 * @param defaultValue
	 ...
	 * In many cases you will call {@link caceresenzo.libs.http.client.webb.Request#ensureSuccess()} instead of this method. But there might be cases where you want to inspect the response-object first (check header values) and then have a short exit where the response-code is not suitable for further normal processing.
	 */
