...
public class ColorUtils {
	...
	public static Color lighter(Color color, double fraction) {
		return lighter(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha(), fraction);
	}
	 ...
	 * @return Lighter color.
	 */
	public static Color lighter(int red, int green, int blue, int alpha, double fraction) {
		red = (int) Math.round(red * (1.0 + fraction));
		green = (int) Math.round(green * (1.0 + fraction));
		blue = (int) Math.round(blue * (1.0 + fraction));
	...
	public static int[] lighterRaw(int red, int green, int blue, int alpha, double fraction) {
		red = (int) Math.round(red * (1.0 + fraction));
		green = (int) Math.round(green * (1.0 + fraction));
		blue = (int) Math.round(blue * (1.0 + fraction));
