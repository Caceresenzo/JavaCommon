...
public class AESEncrypter implements EncrypterBase {
	...
	public enum DRM_TYPE {
		USER_DRM, PRELOAD_DRM, EPUB_COMPONENT_DRM, NO_DRM
	}
	...
	private byte[] asHex(byte buffer[]) {
	 ...
	 */
	@Override
	public void decrypt(InputStream in, OutputStream out) throws IOException, IllegalBlockSizeException, BadPaddingException {
